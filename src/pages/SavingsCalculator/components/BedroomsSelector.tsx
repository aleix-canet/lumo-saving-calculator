    ...
    <>
      ...
      <Dialog
        ...
        slotProps={{
          paper: {
            className:
              'w-[90%] md:w-[360px] px-6 py-8 rounded-[32px]! md:rounded-[52px]! shadow-xl flex items-center flex-col relative',
          },
        }}
      >
        <IconButton
        ...
        <DialogContent>
          <div
            className="text-center text-gray-700 text-base! md:text-lg
 font-normal my-6"
          >
          ...
          <div className="flex items-center justify-center gap-4">
            <IconButton
              onClick={decrement}
              className="border! border-gray-500! border-3! text-gray-700! w-9 h-9 md:w-10 md:h-10"
            >
